        ...
        var picker = {},
            ...
            getMoment = function(d) {
                ...
                if (d === undefined || d === null) {
                    returnMoment = moment();                 } else if (moment.isDate(d) || moment.isMoment(d)) {
                                                            returnMoment = moment(d);
                } else if (hasTimeZone()) {                                         returnMoment = moment.tz(d, parseFormats, options.useStrict, options.timeZone);
                } else {
            ...
            fillDate = function() {
                ...
                for (i = 0; i < 42; i++) {                     if (currentDate.weekday() === 0) {
                        row = $('<tr>');
            ...
            actions = {
                ...
                togglePicker: function(e) {
                    ...
                    if (expanded && expanded.length) {
                        ...
                        if (expanded.collapse) {                             expanded.collapse('hide');
                            closed.collapse('show');
                        } else {                             expanded.removeClass('show');
            ...
            show = function() {
                ...
                widget.on('click', '[data-action]', doAction);                 widget.on('mousedown', false);
                if (component && component.hasClass('btn')) {
                    component.toggleClass('active');
                }
                place();
            ...
            initFormatting = function() {
                ...
                actualFormat = format.replace(/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, function(formatInput) {
                    ...
                    return newinput.replace(/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, function(formatInput2) {                         return date.localeData().longDateFormat(formatInput2) || formatInput2;
                    });
                });
