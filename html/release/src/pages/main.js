...
let jkp = new class
{
    __constructor() {
        ...
        wrapper.innerHTML = `<div class="section">    <!--     *********    BULLET SCREEN      *********      -->    <div class="row bullet-screen"> </div>    <!--     *********    END BULLET SCREEN      *********      -->    <!--     *********    PUNCH-BOX     *********      -->    <div class="about-description text-center">        <div class="features-5 choose-punch">            <div class="container">                <div class="row">                    <div class="col-md-8 mr-auto ml-auto score">                        <span class="badge badge-score" id="my_score">${user.total_score}</span>                    </div>                </div>                <div class="row">                    <div class="col-md-4 punch-pattern">                        <div class="card card-testimonial">                            <div class="card-avatar" data-flag="jkp" data-value="1">                                <a href="javascript:;" data-pattern="#Jan">                                    <img class="img img-raised" src="./assets/img/jan.png">                                </a>                            </div>                            <div class="card-body">                                <p class="card-description">                                    告诉你们一个小技巧秘密，猜拳的时候出剪刀的胜率是33.33%。                                </p>                            </div>                            <div class="icon icon-primary">                                <i class="fa fa-quote-right"></i>                            </div>                            <div class="card-footer">                                <h4 class="card-title">Jan</h4>                                <p class="category">@夺命连环剪刀</p>                            </div>                        </div>                    </div>                    <div class="col-md-4 punch-pattern">                        <div class="card card-testimonial">                            <div class="card-avatar" data-flag="jkp" data-value="2">                                <a href="javascript:;" data-pattern="#Ken">                                    <img class="img img-raised" src="./assets/img/ken.png">                                </a>                            </div>                            <div class="card-body">                                <p class="card-description">                                    又臭又硬的石头，总是出石头的人性格大概也是如此吧。                                </p>                            </div>                            <div class="icon icon-primary">                                <i class="fa fa-quote-right"></i>                            </div>                            <div class="card-footer">                                <h4 class="card-title">Ken</h4>                                <p class="category">@茅坑里的石头</p>                            </div>                        </div>                    </div>                    <div class="col-md-4 punch-pattern">                        <div class="card card-testimonial">                            <div class="card-avatar" data-flag="jkp" data-value="3">                                <a href="javascript:;" data-pattern="#Pon">                                    <img class="img img-raised" src="./assets/img/pon.png">                                </a>                            </div>                            <div class="card-body">                                <p class="card-description">                                    包罗万象，五指张开，出布的时候有一种烟花绽放的感觉。                                </p>                            </div>                            <div class="icon icon-primary">                                <i class="fa fa-quote-right"></i>                            </div>                            <div class="card-footer">                                <h4 class="card-title">Pon</h4>                                <p class="category">@从天而降的帕子</p>                            </div>                        </div>                    </div>                </div>            </div>        </div>    </div>    <!--     *********    END PUNCH-BOX      *********      --></div>`;
...
export class main
{
    ...
    initAppPage() {
        common.render(`<nav class="navbar navbar-toggleable-md bg-white fixed-top navbar-transparent" color-on-scroll="50">    <div class="container">        <div class="navbar-translate">            <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navigation" aria-controls="navigation-index" aria-expanded="false" aria-label="Toggle navigation">                <span class="navbar-toggler-bar bar1"></span>                <span class="navbar-toggler-bar bar2"></span>                <span class="navbar-toggler-bar bar3"></span>            </button>            <a class="navbar-brand" href="javascript:;" >                Jan Ken Pon            </a>        </div>        <div class="collapse navbar-collapse justify-content-end" data-nav-image="./assets/images/blurred-image-1.jpg" data-color="eggyellow">            <ul class="navbar-nav">                <li class="nav-item active">                    <a data-target="jkp" class="nav-page nav-link" href="javascript:;">                        <i class="now-ui-icons tech_controller-modern"></i>                        <p>出拳吧</p>                    </a>                </li>                <li class="nav-item">                    <a data-target="rank" class="nav-page nav-link" href="javascript:;">                        <i class="now-ui-icons sport_trophy"></i>                        <p>排行榜</p>                    </a>                </li>                <li class="nav-item">+                    <li class="nav-item punch-history" data-toggle="popover" data-placement="bottom" data-content="你可以在这里看你的出拳记录哦！" href="javascript:;">                        <i class="now-ui-icons design_bullet-list-67"></i>                        <p>出拳记录</p>                    </a>                </li>            </ul>        </div>    </div></nav><div class='wrapper'></div><script src="http://assets.aoowu.org/js/now-ui-kit.js?v=1.0.1" type="text/javascript"></script>`);
