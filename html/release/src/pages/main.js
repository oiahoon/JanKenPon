...
let rank = new class
{
    __constructor() {
        let wrapper = $('.wrapper')[0];
        wrapper.innerHTML = `<div class="container">    <div class="row">        <div class="col-md-12">            <h4>                <small>排行榜(应该没有超过100个人在玩，吧？)</small>            </h4>        </div>        <div class="col-md-12">            <div class="card card-plain">                <div class="card-body">                    <div class="table-responsive">                        <table class="table table-shopping">                            <thead class="">                            <tr>                                <th class="text-center"> </th>                                <th>                                    拳手                                </th>                                <th class="text-center">                                    积分                                </th>                                <th class="text-right">                                    胜率                                </th>                                <th class="text-right">                                    总局数                                </th>                            </tr>                            </thead>                            <tbody id="rankList"></tbody>                        </table>                    </div>                </div>            </div>        </div>    </div></div>`;
...
let histories = new class
{
    __constructor() {
        let wrapper = $('.wrapper')[0];
        wrapper.innerHTML = `<div class="container">    <div class="row">        <div class="col-md-12">            <h4>                <small>出拳记录(鱿鱼技术原因，只显示最近100条)</small>            </h4>        </div>        <div class="col-md-12">            <div class="card card-plain">                <div class="card-body">                    <div class="table-responsive">                        <table class="table table-shopping">                            <thead class="">                            <tr>                                <th class="text-center">                                    出拳                                </th>                                <th class="text-center">                                    押金                                </th>                                <th class="text-center">                                    积分快照                                </th>                                <th class="text-center">                                    对手                                </th>                                <th class="text-center">                                    结果                                </th>                            </tr>                            </thead>                            <tbody id="historiesTable"></tbody>                        </table>                    </div>                </div>            </div>        </div>    </div></div>`;
        wrapper.className = 'wrapper rank-list';
        this.page  = 1;
...
export class main
{
    ...
    initAppPage() {
        common.render(`<ul class="navbar-nav">    <li class="nav-item active">        <a data-target="jkp" class="nav-page nav-link" href="javascript:;">            <i class="now-ui-icons tech_controller-modern"></i>            <p>出拳吧</p>        </a>    </li>    <li class="nav-item">        <a data-target="rank" class="nav-page nav-link" href="javascript:;">            <i class="now-ui-icons sport_trophy"></i>            <p>排行榜</p>        </a>    </li>    <li class="nav-item">        <a data-target="histories" class="nav-page nav-link" href="javascript:;">            <i class="now-ui-icons design_bullet-list-67"></i>            <p>出拳记录</p>        </a>    </li></ul>`);
